                ...
                <div class="row no-gutters" style="background-color: #7556f3;clip-path: none;">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text">Планн - простой и быстрый трекер задач для руководителя малого бизнеса, построенный на принципах матрицы Эйзенхауэра. Просто попробуйте создать новую задачу и выберите вкладку для нее.</p>
